...
function Auth({isModel = false}) {
    ...
    const handleGoogleAuth = async () => {
        try {
            ...
            alert("Authentication failed. Please check your console for details.")
    ...
    `}>
      ...
      `}>
        ...
        track your progress, and unlock detailed performance insights.
            ...
            className='w-full flex items-center justify-center gap-3 py-3 bg-black text-white rounded-full shadow-md mb-3'>
                <FcGoogle size={20}/>
            ...
            onClick={async () => {
                try {
                    ...
                    alert("Guest login failed. Is your backend running and DB connected?")
                }
            }}
            whileHover={{opacity:0.9 , scale:1.03}}
            whileTap={{opacity:1 , scale:0.98}}
